...
export function TournamentsView({ initialGameId }: TournamentsViewProps) {
  ...
  // ====================================================
  // DELETE TOURNAMENT MODE: DELETE /api/admin/competition/modes/:id
  // ====================================================
  ...
  async function handleDeleteMode() {
    ...
    try {
      ...
      setSuccessMessage(`Tournament Mode "${modeToDelete.name}" deleted successfully.`)
      ...
      setErrorMessage(
        err instanceof Error
          ? err.message
          : `Failed to delete Tournament Mode "${modeToDelete.name}". It may have active match schedules.`
      )
    } finally {
  ...
  // ====================================================
  // DELETE TOURNAMENT SCHEDULE: DELETE /api/admin/competition/schedules/:id
  // ====================================================
  ...
  async function handleDeleteSchedule() {
    ...
    try {
      ...
      setSuccessMessage(`Tournament Schedule slot deleted successfully.`)
      ...
      setErrorMessage(
        err instanceof Error
          ? err.message
          : `Failed to delete Tournament Schedule slot.`
      )
    } finally {
  ...
  return (
    <div className="domain-view-container tournament-domain-theme">
                  ...
                  <div className="schedule-card-header">
                    ...
                    <div className="card-action-icons">
                      ...
                      <button
                        ...
                        title="Delete Tournament Schedule Slot"
                      >
                        <Trash2 size={13} />
                      </button>
                    </div>
            ...
            <form onSubmit={handleUpdateMode} className="modal-form">
              ...
              <div className="modal-actions-spaced">
                <button
                  ...
                  title="Delete this Tournament mode permanently"
                >
      ...
      {/* ======================================================== */}
      {/* MODAL: DELETE TOURNAMENT MODE CONFIRMATION               */}
      {/* ======================================================== */}
          ...
          <div className="modal-content modal-confirm" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <div className="modal-title-wrap">
                ...
                <h3 style={{ color: 'var(--coral-color)' }}>Delete Tournament Mode: {modeToDelete.name}?</h3>
              </div>
              <button
                className="close-btn"
            ...
            <div className="modal-actions">
              ...
              <button
                ...
                disabled={deletingMode}
              >
                {deletingMode ? 'Deleting...' : 'Yes, Delete Tournament Mode'}
              </button>
            </div>
          </div>
        </div>
      ...
      {/* ======================================================== */}
      {/* MODAL: DELETE TOURNAMENT SCHEDULE CONFIRMATION           */}
      {/* ======================================================== */}
        ...
        <div className="modal-overlay" onClick={() => !deletingSchedule && setShowDeleteScheduleModal(false)}>
          <div className="modal-content modal-confirm" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <div className="modal-title-wrap">
                <Trash2 size={20} color="var(--coral-color)" />
                <h3 style={{ color: 'var(--coral-color)' }}>Delete Tournament Schedule Slot?</h3>
              </div>
              <button
                className="close-btn"
